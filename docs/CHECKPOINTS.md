...
| 2 | LeadFlow Enrichment | `projects/02-leadflow-enrichment` | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ TODO |
| 3 | DuraSupport | `projects/03-durable-support` | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ TODO |
| 4 | ZeroTrust-SQL | `projects/04-zerotrust-sql` | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ TODO |
...
## Active project
**#2 LeadFlow Enrichment** — P1 done & verified (8 tests green, local smoke OK). Building P2 next.
